...
def main():
    freshness = Freshness(dbpath='postgresql://postgres@hdxdatafreshness_database_1:5432', save=True)  # dbpath='postgresql://username:password@localhost:5432/freshness',

...
class TestRetrieve:
    def test_retrieve(self):
        ...
        assert result['10'][2] == 'File mimetype text/html; charset=utf-8 does not match HDX format csv!'
        assert result['10'][4] == '9070c22e0c8c41204c6d4e509929246e'
        assert result['11'][0] == url9
        assert result['11'][1] == 'xls'
        assert result['11'][
                   2] == 'File mimetype text/html; charset=utf-8 does not match HDX format xls! File signature b\'<htm\' does not match HDX format xls!'
